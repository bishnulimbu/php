    ...
    <div class="bg-white py-24 sm:py-32">
        <div class="mx-auto max-w-7xl px-6 lg:px-8">
            ...
            @foreach ($posts as $post)
                <article
                    class="relative isolate flex flex-col gap-8 lg:flex-row mt-10 bg-black/10 rounded-2xl shadow-md p-6 lg:p-12 hover:bg-black/30 transition-all duration-300">
                    ...
                    <div class="w-full lg:w-1/2">
                        ...
                        <div class="relative mt-8 flex items-center gap-x-4">
                            <img src="https://ui-avatars.com/api/?name={{ urlencode($post->user->name) }}&background=0D8ABC&color=fff"
                                alt="{{ $post->user->name }}" class="h-10 w-10 rounded-full bg-gray-50">
