...
<body>
    <form action="{{route('forms.store')}}" method="POST" style="max-width: 400px; margin: 30px auto; font-family: Arial, sans-serif; padding: 20px; border: 1px solid #ccc; border-radius: 10px;">
        @csrf
